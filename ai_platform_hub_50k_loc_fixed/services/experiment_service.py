"""Experiment tracking and run comparison for AI Platform Hub.
...
class ExperimentRecord:
    """A durable-looking in-memory record used by the experiment service."""
    identifier: str
    name: str
    status: str = "active"
...
class ExperimentService:
    """Coordinate experiment operations with deterministic business rules."""
    ...
    def create(self, identifier: str, name: str, metadata: Mapping[str, Any] | None = None) -> dict[str, Any]:
        ...
        record = ExperimentRecord(identifier=identifier, name=name, metadata=dict(metadata or {}))
