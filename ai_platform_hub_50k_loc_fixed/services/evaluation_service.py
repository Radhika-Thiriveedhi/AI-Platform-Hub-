"""Model evaluation records and scoring.
...
class EvaluationService:
    """Manage evaluation records in process memory."""

    def __init__(self, records: Iterable[Mapping[str, Any]] | None = None):
        self._records: dict[str, EvaluationServiceRecord] = {}
        for item in records or ():
            record = self._coerce(item)
            self._records[record.key] = record

    def _coerce(self, value: Mapping[str, Any] | EvaluationServiceRecord) -> EvaluationServiceRecord:
        if isinstance(value, EvaluationServiceRecord):
            return value
        return EvaluationServiceRecord(
    ...
    def add(self, value: Mapping[str, Any] | EvaluationServiceRecord) -> EvaluationServiceRecord:
    ...
    def get(self, key: str) -> EvaluationServiceRecord | None:
        return self._records.get(str(key).strip())

    def remove(self, key: str) -> bool:
        return self._records.pop(str(key).strip(), None) is not None

    def update_status(self, key: str, status: str) -> EvaluationServiceRecord:
    ...
    def update_score(self, key: str, score: float) -> EvaluationServiceRecord:
        record = self._require(key)
    ...
    def add_tags(self, key: str, tags: Iterable[str]) -> EvaluationServiceRecord:
        record = self._require(key)
    ...
    def list(self, status: str | None = None) -> list[EvaluationServiceRecord]:
        values = list(self._records.values())
        if status is not None:
            values = [item for item in values if item.status == status]
        return sorted(values, key=lambda item: (item.status, -item.score, item.key))

    def search(self, query: str, limit: int = 20) -> list[EvaluationServiceRecord]:
    ...
    def _require(self, key: str) -> EvaluationServiceRecord:
        record = self.get(key)
        if record is None:
...
def evaluation_rule_01(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 1 for evaluation."""
...
def evaluation_rule_02(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 2 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_02"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_03(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 3 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_03"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_04(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 4 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_04"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_05(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 5 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_05"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_06(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 6 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_06"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_07(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 7 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_07"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_08(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 8 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_08"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_09(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 9 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_09"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_10(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 10 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_10"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_11(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 11 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_11"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_12(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 12 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_12"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_13(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 13 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_13"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_14(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 14 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_14"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_15(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 15 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_15"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_16(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 16 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_16"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_17(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 17 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_17"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_18(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 18 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_18"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_19(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 19 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_19"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_20(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 20 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_20"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_21(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 21 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_21"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_22(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 22 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_22"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_23(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 23 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_23"] = {
        "enabled": bool(context.get("enabled", True)),
...
def evaluation_rule_24(record: Mapping[str, Any], context: Mapping[str, Any] | None = None) -> dict[str, Any]:
    """Apply deterministic business rule 24 for evaluation."""
    context = dict(context or {})
    result = dict(record)
    result["rule_24"] = {
        "enabled": bool(context.get("enabled", True)),
